...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsAsSpaceIndex = __webpack_require__(16);
	...
	var transitionsIn = ['scaleIn', 'rotateInQuarterClockwise', 'slideInBottom', 'slideInRight', 'slideInTop', 'slideInLeft'];

	var transitionsOut = ['scaleOut', 'zoomOut', 'rotate3dOut', 'slideOutDown', 'slideOutLeft', 'slideOutRight', 'slideOutUp'];

	var randomTransitionIn = function randomTransitionIn() {
		return transitionsIn[Math.floor(Math.random() * transitionsIn.length)];
	};

	var randomTransitionOut = function randomTransitionOut() {
		return transitionsOut[Math.floor(Math.random() * transitionsOut.length)];
	};

	var prevCallback = function prevCallback() {
		space.prev();
	};
	...
	var space = _react2['default'].render(_react2['default'].createElement(
		_componentsAsSpaceIndex.AsSpace,
		{ selector: '.custom-frame' },
		_react2['default'].createElement(
			'span',
			{ className: 'fix prev', onClick: prevCallback },
			'<'
		),
		_react2['default'].createElement(
			'span',
			{ className: 'fix next', onClick: nextCallback },
			'>'
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement(
				'h1',
				null,
				'我的滑板鞋'
		...
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/1.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/2.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/3.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/4.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/5.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/6.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/7.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/8.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/9.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/10.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/11.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/12.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/13.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/14.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/15.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/16.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/17.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/18.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/19.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
			_react2['default'].createElement('img', { src: 'http://skyinlayerblog.qiniudn.com/huabanxie/20.jpg', alt: '' })
		),
		_react2['default'].createElement(
			_componentsAsSpaceIndex.AsSpaceFrame,
			{ classes: ['custom-frame'], exit: 'fadeOut ' + randomTransitionOut(), enter: 'fadeIn' + randomTransitionIn() },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SpaceController = __webpack_require__(25);
	...
	var AsSpace = (function (_React$Component) {
		function AsSpace(props) {
			...
			_classCallCheck(this, AsSpace);

			_get(Object.getPrototypeOf(AsSpace.prototype), 'constructor', this).call(this);

			this.prev = function () {
				_this.spaceController.scrollToPrevFrame();
			};

			this.next = function () {
				_this.spaceController.scrollToNextFrame();
			};

			this.componentDidMount = function () {
				_this.spaceController.init();
			};
			...
			this.spaceController = new _SpaceController2['default']({
				frameSelector: props.selector
			});
			this.spaceController.addTransitions(props.customTransitions);
		}

		_inherits(AsSpace, _React$Component);

		_createClass(AsSpace, null, [{
			key: 'propTypes',
			value: {
				selector: _react2['default'].PropTypes.string,
				customTransitions: _react2['default'].PropTypes.object
			},
			enumerable: true
		}, {
			key: 'defaultProps',
	...
	var AsSpaceFrame = (function (_React$Component2) {
		function AsSpaceFrame() {
			var _this2 = this;

			_classCallCheck(this, AsSpaceFrame);

			_get(Object.getPrototypeOf(AsSpaceFrame.prototype), 'constructor', this).call(this);
			...
			this.render = function () {
				...
				return _react2['default'].createElement(
					...
					{ className: classes.join(' '),
						'data-exit': _this2.props.exit,
						'data-enter': _this2.props.enter,
						'data-transition': _this2.props.transition,
						'data-easing': _this2.props.easing,
						'data-duration': _this2.props.duration },
					_react2['default'].createElement(
						'div',
						{ className: 'as-space-inner-frame' },
		...
		_inherits(AsSpaceFrame, _React$Component2);

		_createClass(AsSpaceFrame, null, [{
			key: 'propTypes',
			value: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _exposeJQueryLibJQueryJqueryMinJs = __webpack_require__(26);

	var _exposeJQueryLibJQueryJqueryMinJs2 = _interopRequireDefault(_exposeJQueryLibJQueryJqueryMinJs);

	var _ScrollController = __webpack_require__(50);

	var _ScrollController2 = _interopRequireDefault(_ScrollController);

	var _Transitions = __webpack_require__(51);

	var _Transitions2 = _interopRequireDefault(_Transitions);

	var _EasingFunctions = __webpack_require__(52);
	...
	var defaultTransition = {
		all: [_Transitions2['default'].scaleOut, _Transitions2['default'].fadeOut],
		enter: [],
		exit: [],
		easing: 'linear'
	};
	...
	var SpaceController = (function () {
		function SpaceController(config) {
			_classCallCheck(this, SpaceController);

			this.$window = (0, _exposeJQueryLibJQueryJqueryMinJs2['default'])(window);
			this.windowHeight = this.$window.height();
			this.scrollControl = new _ScrollController2['default']();
			this.frames = null;
			this.currentFrame = 0;
		...
		_createClass(SpaceController, [{
			key: 'addTransitions',
			value: function addTransitions(customTrans) {
				for (var _name in customTrans) {
					if (_Transitions2['default'][_name]) return console.log('Transition name already exists!!!');
					_Transitions2['default'][_name] = customTrans[_name];
				}
			}
		}, {
			key: 'linearEase',
			value: function linearEase(t, b, c, d) {
				return b + c * (t / d);
			}
		}, {
			key: 'deltaValue',
			value: function deltaValue(animations, delta, property, easing) {
				var animation = animations[property];
				var frameDuration = this.frames[this.currentFrame].duration;
				var frameProgress = delta / frameDuration; // decimal percent

				if (property == 'translate3d' || property == 'rotate3d') {
					var trans = {};
					for (var axis in animation.from) {
						trans[axis] = +_EasingFunctions2['default'][easing](delta, animation.from[axis], animation.to[axis] - animation.from[axis], frameDuration).toFixed(4);
					}return trans;
				} else return +_EasingFunctions2['default'][easing](delta, animation.from, animation.to - animation.from, frameDuration).toFixed(4);
			}
		}, {
			key: 'animate',
			...
			value: function animateFrame() {
				...
				var scrollInElement = this.scrollControl.getScrollTop() - currentFrame.distanceTo;
				var props = {
					transform: ''
				};

				var frameTransition = currentFrame.transition || defaultTransition;

				var setProps = function setProps(type, value) {
					frameTransition[type].forEach(function (trans) {
						for (var property in trans) {
							if (property === 'scale' || property === 'translate3d' || property === 'rotate' || property === 'rotate3d') props['transform'] += (0, _Util.propValueToCssFormat)(property, _this2.deltaValue(trans, value, property, frameTransition.easing));else props[property] = (0, _Util.propValueToCssFormat)(property, _this2.deltaValue(trans, value, property, frameTransition.easing));
						}
					});
				};
				...
				if (scrollInElement <= currentFrame.duration / 2) setProps('enter', scrollInElement * 2);else setProps('exit', (scrollInElement - currentFrame.duration / 2) * 2);

				props['-webkit-transform'] = props['transform'];
				props['-moz-transform'] = props['transform'];
				(0, _exposeJQueryLibJQueryJqueryMinJs2['default'])(currentFrame.selector).css(props);
			}
		}, {
			key: 'setCurrentFrame',
			value: function setCurrentFrame() {
				var top = this.scrollControl.getScrollTop();
				var trigger = this.frames[this.currentFrame].distanceTo;
				if (top < trigger) {
					(0, _exposeJQueryLibJQueryJqueryMinJs2['default'])(this.frameSelector).hide();
					this.currentFrame = Math.max(0, this.currentFrame - 1);
					(0, _exposeJQueryLibJQueryJqueryMinJs2['default'])(this.frames[this.currentFrame].selector).show();
			...
			key: 'scrollToNextFrame',
			value: function scrollToNextFrame() {
				var _this3 = this;

				var frame = this.frames[this.currentFrame + 1];
				if (frame && !this.animating) {
					(0, _exposeJQueryLibJQueryJqueryMinJs2['default'])('html, body').animate({ scrollTop: frame.distanceTo + frame.duration / 2 }, 1000, 'linear', function () {
			...
			key: 'scrollToPrevFrame',
			value: function scrollToPrevFrame() {
				var _this4 = this;
			...
			value: function init() {
				...
				var touchScreenCompensation = (0, _Util.isMobile)() ? 0.3 : 1;
				var simulatedBodyHeight = 0;

				this.frames = (0, _exposeJQueryLibJQueryJqueryMinJs2['default'])(this.frameSelector).map(function (index, frame) {
					var duration = frame.dataset.duration * touchScreenCompensation;
					var simulatedHeight = duration * _this5.windowHeight;
					var distanceTo = simulatedBodyHeight;
					simulatedBodyHeight += simulatedHeight;
					console.log(simulatedBodyHeight, simulatedHeight);
					var frameId = frame.id = 'frame-' + index;
					var customTransition = frame.dataset.transition;
					var customEnter = frame.dataset.enter;
					var customExit = frame.dataset.exit;
					var customEasing = frame.dataset.easing;

					if (customTransition || customEnter || customExit || customEasing) {
						var toTransition = function toTransition(arr) {
							return arr.split(/\s+/).map(function (t) {
								return _Transitions2['default'][t];
							});
						};
				...
				(0, _exposeJQueryLibJQueryJqueryMinJs2['default'])('body').height(simulatedBodyHeight + this.windowHeight);
				(0, _exposeJQueryLibJQueryJqueryMinJs2['default'])(this.frames[this.currentFrame].selector).show();
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, "html,\nbody {\n  margin: 0;\n}\n.as-space .as-space-frame {\n  display: none;\n  position: fixed;\n  width: 100%;\n  height: 100%;\n}\n.as-space .as-space-frame .as-space-inner-frame {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  -webkit-transform-style: preserve-3d;\n          transform-style: preserve-3d;\n  -webkit-transform: translate(-50%, -50%);\n      -ms-transform: translate(-50%, -50%);\n          transform: translate(-50%, -50%);\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScrollController = (function () {
		...
		_createClass(ScrollController, [{
			key: 'repeatOnScroll',
			value: function repeatOnScroll(func, interv) {
				var _this = this;
				...
				this.$window.on('scroll', function () {
					!_this.repeatIntervalId && _this.startRepeat();
				});
			}
		}, {
			key: 'update',
			value: function update() {
				...
				var tmpScrollTop = undefined;
				if ((tmpScrollTop = this.$window.scrollTop()) === this.lastScrollTop) if (++this.delayCount >= 30) {
					this.delayCount = 0;
					this.stopRepeat();
				}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
		...
		propValueToCssFormat: function propValueToCssFormat(prop, val) {
			switch (prop) {
				case 'scale':
					return 'scale(' + val + ')';
				case 'rotate':
				...
				case 'translate3d':
					return 'translate3d(' + (val.x ? val.x + 'px' : 0) + ',' + (val.y ? val.y + 'px' : 0) + ',' + (val.z ? val.z + 'px' : 0) + ')';
				case 'rotate3d':
					return 'rotate3d(' + (val.x ? val.x : 0) + ',' + (val.y ? val.y : 0) + ',' + (val.z ? val.z : 0) + ',' + (val.angle ? val.angle + 'deg' : 0) + ')';
				default:
					return val;
			}
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(71);
	var invariant = __webpack_require__(198);
	var keyMirror = __webpack_require__(209);
	var keyOf = __webpack_require__(210);
	var warning = __webpack_require__(202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MobileSafariClickEventPlugin = __webpack_require__(225);
	...
	var ReactDOMImg = __webpack_require__(230);
	...
	var ServerReactRootIndex = __webpack_require__(241);
	var SimpleEventPlugin = __webpack_require__(242);
	var SVGDOMPropertyConfig = __webpack_require__(243);

	var createFullPageComponent = __webpack_require__(244);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(197);
	var LocalEventTrapMixin = __webpack_require__(275);
	var ReactBrowserComponentMixin = __webpack_require__(226);
	var ReactClass = __webpack_require__(57);
	var ReactElement = __webpack_require__(60);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SyntheticUIEvent = __webpack_require__(292);
	var SyntheticWheelEvent = __webpack_require__(293);

	var getEventCharCode = __webpack_require__(294);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ViewportMetrics = __webpack_require__(299);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CSSProperty = __webpack_require__(304);
	var ExecutionEnvironment = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponentEnvironment = __webpack_require__(281);
	var ReactMultiChildUpdateTypes = __webpack_require__(309);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getEventModifierState = __webpack_require__(314);
