...
/***/ function(module, exports, __webpack_require__) {
	...
	var AsCalendar = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CalendarHeader = __webpack_require__(20);
	var CalendarHead = __webpack_require__(21);
	var CalendarBody = __webpack_require__(22);
	...
	var Calendar = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: 'as-calendar column' },
	      React.createElement(CalendarHeader, { date: date, onNavChange: this.onNavChange }),
	      React.createElement(
	        'div',
	        { className: 'calendar column s9' },
	        React.createElement(CalendarHead, null),
	        React.createElement(CalendarBody, { current: current, date: date, onSelectedChange: this.onSelectedChange })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CalendarHeader = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "div",
	      { className: "header row s1" },
	      React.createElement(
	        "div",
	        { onClick: self.onClickLeft, className: "nav-btn s1 center" },
	        "<"
	      ),
	      React.createElement(
	        "div",
	        { className: "current s5 center" },
	        React.createElement(
	          "span",
	          null,
	          year,
	      ...
	      React.createElement(
	        "div",
	        { onClick: self.onClickRight, className: "nav-btn s1 center" },
	        ">"
	      )
	    );
	  }
	  ...
	  render: function render() {
	    ...
	    var rows = table.map(function (row) {
	      var days = row.map(function (day, index) {
	        ...
	        return React.createElement(
	          'div',
	          { className: className, onClick: pressCb },
	          day,
	          lunarDate
	        );
	      });
